...
export default async function CourseApplySuccessPage({ searchParams }: Props) {
  ...
  return (
    <main className="min-h-screen bg-emerald-50 px-4 py-14 text-slate-900">
      <div className="mx-auto w-full max-w-2xl rounded-3xl border border-emerald-200 bg-white p-7 shadow-sm sm:p-9">
        ...
        <h1 className="mt-4 text-3xl font-extrabold text-slate-900">Enrollment request submitted</h1>
        <p className="mt-2 text-sm text-slate-600 sm:text-base">
          Thanks for applying. Our academy team will contact you with batch details and next steps.
        </p>
