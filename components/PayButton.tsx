...
export default function PayButton({ amount, planName, buttonText, className = "" }: PayButtonProps) {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleForm}
        className={`relative bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-semibold shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 ease-out group overflow-hidden ${className}`}
      >
