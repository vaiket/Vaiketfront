...
export default function Pricing() {
  ...
  const pricingSchema = {
    ...
    "@type": "Product",
    "name": "Arte - AI Email & WhatsApp Automation",
    "description": "AI-powered email and WhatsApp automation platform for businesses",
    "offers": {
      "@type": "AggregateOffer",
      "offerCount": 3,
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/20 border border-blue-500/30 mb-6 backdrop-blur-sm"
            >
              <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse" />
              <span className="text-sm text-blue-300 font-medium">Pricing</span>
            </motion.div>
            
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-sora bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
            ...
            >
              <div className="flex">
                <button
                  ...
                  className={`relative z-10 px-8 py-3 rounded-lg text-sm font-medium transition-all duration-300 font-inter ${
                ...
                <button
                  ...
                  className={`relative z-10 px-8 py-3 rounded-lg text-sm font-medium transition-all duration-300 font-inter flex items-center gap-2 ${
              ...
              <motion.div
                ...
                className="absolute inset-1.5 w-1/2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg"
              />
            </motion.div>
          </motion.div>
              ...
              >
                ...
                {plan.highlight && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 px-6 py-2 rounded-full text-sm font-bold font-sora flex items-center gap-2 shadow-lg">
                ...
                <div className="p-8 flex flex-col h-full">
                  ...
                  <div className="text-center mb-8">
                    ...
                    {/* Value Metric */}
                    <p className="text-lg text-gray-300 font-inter font-medium">
                      {plan.valueMetric}
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 mt-auto">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`w-full py-4 px-6 rounded-xl font-semibold transition-all duration-300 font-sora ${
                        plan.highlight
                    ...
                    {/* WhatsApp CTA for Growth & Scale */}
                    {(plan.id === 'growth' || plan.id === 'scale') && (
                      <motion.a
                        href="https://wa.me/+917004614077"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="w-full py-3 px-6 bg-gray-800/80 text-white rounded-xl font-semibold hover:bg-gray-700/80 transition-all duration-300 font-inter flex items-center justify-center gap-2 border border-gray-700"
                      >
                    ...
                    {/* Trial Note */}
                    {plan.noCreditCard && (
                      <p className="text-center text-sm text-gray-400 font-inter pt-2">
            ...
            <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/70 max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <h4 className="text-white font-sora font-semibold mb-2">DPDP Compliant</h4>
                  <p className="text-gray-400 text-sm">Fully compliant with Indian data laws</p>
                </div>
                <div className="flex flex-col items-center">
                  <Zap className="w-8 h-8 text-blue-400 mb-3" />
                  <h4 className="text-white font-sora font-semibold mb-2">5-Minute Setup</h4>
                  <p className="text-gray-400 text-sm">Get started in under 5 minutes</p>
                </div>
                <div className="flex flex-col items-center">
                  <Users className="w-8 h-8 text-purple-400 mb-3" />
                  <h4 className="text-white font-sora font-semibold mb-2">24/7 Support</h4>
